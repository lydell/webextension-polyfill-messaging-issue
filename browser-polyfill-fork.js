(function (global, factory) {
  ...
  /* webextension-polyfill - v0.2.1 - Tue Jun 19 2018 17:24:39 */
    ...
    const wrapAPIs = () => {
      ...
      const wrappedSendMessageCallback = ({ reject, resolve }, reply) => {
        if (chrome.runtime.lastError) {
          ...
          // console.log(response) })` is a mistake if the other end does not send
          // a message. As an extension author you know whether that's the case or
          // not, so Chrome reports this as an error. However, in order to
